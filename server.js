    ...
    if (socket.id == adminId) {
        ...
        if(recievedJSON.tt[i + 2].__EMPTY && recievedJSON.tt[i + 2].__EMPTY_1){
          ...
          if (i < 3) {
            ...
            if (recievedJSON.tt[i + 2].__EMPTY_3){
              ttData.questions[i].answer_image = recievedJSON.tt[i + 2].__EMPTY_3;
            }  
          }
          else {
      ...
      for (let i = 3; i <= 8; i++) {
        ...
        if (recievedJSON.vd[i].__EMPTY_2) {
          ...
          vdData.questionPools[0][i - 3].file_name = recievedJSON.vd[i].__EMPTY_4;
        }
        else {
      ...
      for (let i = 11; i <= 16; i++) {
        ...
        if (recievedJSON.vd[i].__EMPTY_2) {
          ...
          vdData.questionPools[1][i - 11].file_name = recievedJSON.vd[i].__EMPTY_4;
        }
        else {
      ...
      for (let i = 19; i <= 24; i++) {
        ...
        if (recievedJSON.vd[i].__EMPTY_2) {
          ...
          vdData.questionPools[2][i - 19].file_name = recievedJSON.vd[i].__EMPTY_4;
        }
        else {
      ...
      for (let i = 27; i <= 32; i++) {
        ...
        if (recievedJSON.vd[i].__EMPTY_2) {
          ...
          vdData.questionPools[3][i - 27].file_name = recievedJSON.vd[i].__EMPTY_4;
        }
        else {
